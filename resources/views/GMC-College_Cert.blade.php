...
<body>
    <div class="certificate">
        ...
        <div class="content">
        It is further certified that {{ $student->sex == 'M' ? 'he' : 'she' }} is of good moral character and has never been
        subjected to any disciplinary action during {{ $student->sex == 'M' ? 'his' : 'her' }} entire stay in this University.
        </div>
